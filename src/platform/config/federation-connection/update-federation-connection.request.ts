...
export class UpdateFederationConnectionRequest
    implements Partial<Pick<FederationConnectionResponse, 'type' | 'name' | 'clientId' | 'loginUrl' | 'certificate' | 'requestMethod' | 'signedRequest' | 'signedRequestAlgorithm' | 'signedRequestPrivateKey'>>
{    
